...
IMAGE_TYPEDEP:hdfastboot8gb = "ext4 tar"
...
IMAGE_CMD:hdfastboot8gb () {
    ...
    echo "bootcmd=setenv vfd_msg -e2-; setenv notee y; setenv bootargs \$(bootargs) \$(bootargs_common); mmc read 0 0x1000000 0x3BD000 0x8000; bootm 0x1000000; run bootcmd_fallback" > ${UNPACKDIR}/STARTUP
    ...
    echo "bootargs=androidboot.hardware=bigfish androidboot.serialno=0123456789 androidboot.selinux=disabled hbcomp=/dev/block/mmcblk0p13 root=/dev/mmcblk0p13 androidboot.dtbo_idx=0" >> ${UNPACKDIR}/STARTUP_ANDROID
    ...
    echo "bootargs=androidboot.hardware=bigfish androidboot.serialno=0123456789 androidboot.selinux=disabled hbcomp=/dev/block/mmcblk0p13 root=/dev/mmcblk0p13 androidboot.dtbo_idx=0" >> ${UNPACKDIR}/STARTUP_ANDROID_DISABLE_LINUXSE
    echo "bootcmd=setenv vfd_msg -e2-; setenv notee y; setenv bootargs \$(bootargs) \$(bootargs_common); mmc read 0 0x1000000 0x3BD000 0x8000; bootm 0x1000000; run bootcmd_fallback" > ${UNPACKDIR}/STARTUP_LINUX_1
    ...
    echo "bootcmd=setenv vfd_msg -e2-; setenv notee y; setenv bootargs \$(bootargs) \$(bootargs_common); mmc read 0 0x1000000 0x3C5000 0x8000; bootm 0x1000000; run bootcmd_fallback" > ${UNPACKDIR}/STARTUP_LINUX_2
    ...
    echo "bootcmd=setenv vfd_msg -e2-; setenv notee y; setenv bootargs \$(bootargs) \$(bootargs_common); mmc read 0 0x1000000 0x3CD000 0x8000; bootm 0x1000000; run bootcmd_fallback" > ${UNPACKDIR}/STARTUP_LINUX_3
    ...
    echo "bootcmd=setenv vfd_msg -e2-; setenv notee y; setenv bootargs \$(bootargs) \$(bootargs_common); mmc read 0 0x1000000 0x3D5000 0x8000; bootm 0x1000000; run bootcmd_fallback" > ${UNPACKDIR}/STARTUP_LINUX_4
    ...
    echo "bootcmd=setenv vfd_msg rcvy; setenv notee y; setenv bootargs \$(bootargs_common); mmc read 0 0x1000000 0x1000 0x9000; bootm 0x1000000" > ${UNPACKDIR}/STARTUP_RECOVERY
    echo "imageurl https://raw.githubusercontent.com/oe-alliance/bootmenu/master/${MACHINE}/images" > ${UNPACKDIR}/bootmenu.conf
    echo "updateurl http://updateurl.ddns.net/cgi-bin/index.py" >> ${UNPACKDIR}/bootmenu.conf
    ...
    echo -n boot-recovery > ${UNPACKDIR}/misc-boot.img
