...
IMAGE_CMD:maxytecfastboot8gb () {
    ...
    echo "bootargs=androidboot.hardware=bigfish androidboot.serialno=0123456789 androidboot.selinux=disabled hbcomp=/dev/block/mmcblk0p13 androidboot.dtbo_idx=0" >> ${UNPACKDIR}/STARTUP_ANDROID
    ...
    echo "bootargs=androidboot.hardware=bigfish androidboot.serialno=0123456789 androidboot.selinux=disabled hbcomp=/dev/block/mmcblk0p13 androidboot.dtbo_idx=0" >> ${UNPACKDIR}/STARTUP_ANDROID_DISABLE_LINUXSE
